...
package int8_mac_instr_pkg;
  ...
  typedef enum logic [3:0] {
    ...
    // Grouped Phase-1 opcodes (sub-op selected by funct3)
    MATMUL_CTRL       = 4'b1100,
    NORM_ACT          = 4'b1101
  } opcode_t;
...
`ifndef GARUDA_SIMPLE_PKG
  parameter int unsigned NbInstr = 18;  // 7 existing + 4 attention + 7 grouped Phase-1 entries
  ...
  parameter copro_issue_resp_t CoproInstr[NbInstr] = '{
      ...
      '{
        ...
        // ---------------------------------------------------------------------
        // Grouped Phase-1 opcodes (funct3 sub-ops)
        // ---------------------------------------------------------------------

        // MATMUL_CTRL: MM_RESET
        '{
          instr: 32'b0001011_00000_00000_000_00000_1111011,
          mask:  32'b1111111_00000_00000_111_00000_1111111,
          resp: '{accept: 1'b1, writeback: 1'b0, register_read: 3'b000},
          opcode: MATMUL_CTRL
        },

        // MATMUL_CTRL: MM_LOAD_W
        '{
          instr: 32'b0001011_00000_00000_001_00000_1111011,
          mask:  32'b1111111_00000_00000_111_00000_1111111,
          resp: '{accept: 1'b1, writeback: 1'b0, register_read: 3'b001},
          opcode: MATMUL_CTRL
        },

        // MATMUL_CTRL: MM_LOAD_A
        '{
          instr: 32'b0001011_00000_00000_010_00000_1111011,
          mask:  32'b1111111_00000_00000_111_00000_1111111,
          resp: '{accept: 1'b1, writeback: 1'b0, register_read: 3'b001},
          opcode: MATMUL_CTRL
        },
        ...
        // MATMUL_CTRL: MM_RUN
        '{
          instr: 32'b0001011_00000_00000_011_00000_1111011,
          mask:  32'b1111111_00000_00000_111_00000_1111111,
          resp: '{accept: 1'b1, writeback: 1'b0, register_read: 3'b010},
          opcode: MATMUL_CTRL
        },

        // MATMUL_CTRL: MM_DRAIN
        '{
          instr: 32'b0001011_00000_00000_100_00000_1111011,
          mask:  32'b1111111_00000_00000_111_00000_1111111,
            resp: '{accept: 1'b1, writeback: 1'b1, register_read: 3'b001},
          opcode: MATMUL_CTRL
        },
        ...
        // NORM_ACT: GELU8
        '{
          instr: 32'b0001100_00000_00000_000_00000_1111011,
          mask:  32'b1111111_00000_00000_111_00000_1111111,
          resp: '{accept: 1'b1, writeback: 1'b0, register_read: 3'b001},
          opcode: NORM_ACT
        },
        ...
        // NORM_ACT: LNORM8
        '{
          instr: 32'b0001100_00000_00000_001_00000_1111011,
          mask:  32'b1111111_00000_00000_111_00000_1111111,
          resp: '{accept: 1'b1, writeback: 1'b0, register_read: 3'b001},
          opcode: NORM_ACT
      }
...
`endif
  ...
  function automatic string opcode_to_string(opcode_t op);
    case (op)
      ...
      MATMUL_CTRL:       return "MATMUL_CTRL";
      NORM_ACT:          return "NORM_ACT";
